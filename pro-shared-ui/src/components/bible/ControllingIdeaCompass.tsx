    ...
    <PanelShell {...props}>
      <div data-screen-label="Controlling-Idea Compass" style={panelBox}>
        ...
        <div style={{ height: 38, flex: "none", display: "flex", alignItems: "center", gap: 9, padding: "0 14px", borderBottom: "1px solid var(--line)" }}>
          <span style={{ fontFamily: "'Chakra Petch'", fontWeight: 600, fontSize: 13, letterSpacing: ".1em", color: "var(--strong)" }}>CONTROLLING IDEA</span>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: 16 }}>
          <div style={{ display: "flex", gap: 16, alignItems: "center", marginBottom: 18 }}>
            ...
            <div style={{ flex: "none", position: "relative", width: 120, height: 120 }}>
              ...
              <div style={{ position: "absolute", inset: 9, borderRadius: "50%", background: "var(--panel2)", border: "1px solid var(--line2)" }} />
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontFamily: "'Chakra Petch'", fontSize: 16, lineHeight: 1.35, color: "var(--strong)" }}><span style={{ color: "var(--green)" }}>JUSTICE</span> prevails <span style={{ color: "var(--txt2)" }}>when</span> the powerless break their silence.</div>
          ...
          <div style={{ display: "flex", gap: 2, height: 22, marginBottom: 8 }}>
            {seg(2, "var(--green)")}{seg(1, "var(--amber)")}{seg(3, "var(--green)")}{seg(1, "var(--blocking)")}{seg(2, "var(--amber)")}{seg(1, "var(--violet)")}{seg(2, "var(--green)")}{seg(1, "var(--tint2)", 1)}{seg(1, "var(--violet)")}
          </div>
