...
export const ROUTES = {
  ...
  comments: (p: number) => `/api/projects/${p}/comments`,
  comment: (p: number, commentId: number) => `/api/projects/${p}/comments/${commentId}`,
  commentReplies: (p: number, commentId: number) => `/api/projects/${p}/comments/${commentId}/replies`,
  commentReply: (p: number, commentId: number, replyId: number) => `/api/projects/${p}/comments/${commentId}/replies/${replyId}`,
