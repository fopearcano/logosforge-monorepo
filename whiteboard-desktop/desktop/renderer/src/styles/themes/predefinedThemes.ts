...
export const MANUSCRIPT: WhiteboardTheme = {
  ...
  selectionBg: 'rgba(176,101,63,0.24)',
  editorSelection: 'rgba(176,101,63,0.28)',
  caret: '#b0653f',
...
export const CHROMA: WhiteboardTheme = {
  ...
  selectionBg: 'rgba(29,78,216,0.22)',
  editorSelection: 'rgba(29,78,216,0.25)',
  caret: '#1d4ed8',
...
export const FORGE: WhiteboardTheme = {
  ...
  selectionBg: 'rgba(228,74,53,0.25)',
  editorSelection: 'rgba(228,74,53,0.30)',
  caret: '#e44a35',
...
export const DEEPDARK: WhiteboardTheme = {
  ...
  selectionBg: 'rgba(232,145,58,0.26)',
  editorSelection: 'rgba(232,145,58,0.30)',
  caret: '#e8913a',
...
export const VIOLET: WhiteboardTheme = {
  ...
  selectionBg: 'rgba(196,167,255,0.28)',
  editorSelection: 'rgba(150,120,240,0.30)',
  caret: '#c4a7ff',
...
export const BLUEPRINT: WhiteboardTheme = {
  ...
  selectionBg: 'rgba(127,177,255,0.28)',
  editorSelection: 'rgba(127,177,255,0.30)',
  caret: '#7fb1ff',
